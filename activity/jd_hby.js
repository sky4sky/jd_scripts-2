...
!(async () => {
  ...
  try {
    const promiseArr = cookiesArr.map((ck, index) => draw(ck, index));
...
function draw(taskCookie, index) {
  ...
  return new Promise(resolve => {
    $.post({
      ...
      headers: {
        ...
        'User-Agent': 'jdapp;iPhone;10.0.2;14.5.1;network/wifi;model/iPhone13,2;appBuild/167688;jdSupportDarkMode/0;Mozilla/5.0 (iPhone; CPU iPhone OS 14_5_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1',
        'Referer': 'https://prodev.m.jd.com/mall/active/31QzsgSooWDuebS3u31MxcSqZ7c2/index.html',
