/*
京东双十一京享红包，每日可中奖3次，最高6666元！
https://u.jd.com/3IXBgiv
...
function getCoupons(shareId = '') {
  return new Promise(resolve => {
    let opts = {
      url: `https://api.m.jd.com/api?functionId=getCoupons&appid=u&_=${Date.now()}&loginType=2&body={%22platform%22:4,%22unionActId%22:%2231134%22,%22actId%22:%22${$.actId}%22,%22d%22:%22${$.hbCode}%22,%22unionShareId%22:%22${shareId}%22,%22type%22:1,%22eid%22:%22${$.eid}%22}&client=apple&clientVersion=8.3.6&h5st=undefined`,
      headers: {
...
function shareUnionCoupon() {
  return new Promise(resolve => {
    let opts = {
      url: `https://api.m.jd.com/api?functionId=shareUnionCoupon&appid=u&_=${Date.now()}&loginType=2&body={%22unionActId%22:%2231134%22,%22actId%22:%22${$.actId}%22,%22platform%22:4,%22unionShareId%22:%22${$.shareCode}%22,%22d%22:%22${$.hbCode}%22,%22supportPic%22:2,%22supportLuckyCode%22:0,%22eid%22:%22${$.eid}%22}&client=apple&clientVersion=8.3.6`,
      headers: {
        "Accept-Language": "zh-cn",
        "Accept-Encoding": "gzip, deflate, br",
        'Cookie': `${cookie} ${newCookie}`,
